    ...
    return (
      <div>
        ...
        <Table celled>
          ...
          <Table.Body>
            {this.state.leagueUsers && this.state.leagueUsers.map(leagueUser => (
              <Table.Row>
                <Table.Cell>
                  <Label ribbon>{leagueUser.user.firstName} {leagueUser.user.lastName}</Label>
                </Table.Cell>
                ...
                <Table.Cell>
                  ...
                  <Modal size='small' open={this.state.open} onClose={this.handleDeleteCancel}>
                    ...
                    <Modal.Actions>
                      ...
                      <Button positive onClick={() => this.handleDeleteConfirm(leagueUser.id)} icon='checkmark' labelPosition='right' content='Ano'/>
                    </Modal.Actions>
                  </Modal>
                </Table.Cell>
              </Table.Row>
