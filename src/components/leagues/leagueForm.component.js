        ...
        <Form onSubmit={() => this.saveForm()}>
          <Form.Field>
            ...
            <Input
              ...
              onChange={(event) =>
                this.setState({
                  league: { ...this.state.league, name: event.target.value },
                })
              }
            />
          </Form.Field>
          ...
          <Form.Field>
            <Form.Select
              ...
              onChange={(event, { value }) => {
                this.setState({
                  league: { ...this.state.league, sportId: value },
                });
              }}
            />
          </Form.Field>
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  league: {
                    ...this.state.league,
                    isActive: !this.state.league.isActive,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  league: {
                    ...this.state.league,
                    isFinished: !this.state.league.isFinished,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  league: {
                    ...this.state.league,
                    isMostActive: !this.state.league.isMostActive,
                  },
                })
              }
            />
