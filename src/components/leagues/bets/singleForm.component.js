        ...
        <Form onSubmit={() => this.saveForm()}>
          <Form.Field>
            <Form.Select
              ...
              onChange={(event, { value }) => {
                this.setState({
                  single: { ...this.state.single, specialBetSingleId: value },
                });
              }}
            />
          </Form.Field>
            ...
            <Form.Select
              ...
              onChange={(event, { value }) => {
                this.setState({
                  single: {
                    ...this.state.single,
                    specialBetPlayerResultId: value,
                  },
                });
              }}
            />
            ...
            <Input
              ...
              onChange={(event) =>
                this.setState({
                  single: {
                    ...this.state.single,
                    specialBetValue: event.target.value,
                  },
                })
              }
            />
          ...
          <Form.Field>
            ...
            <Input
              ...
              onChange={(event) =>
                this.setState({
                  single: { ...this.state.single, points: event.target.value },
                })
              }
            />
          </Form.Field>
          <Form.Field>
            ...
            <DatePicker
              ...
              onChange={(event) =>
                this.setState({
                  single: { ...this.state.single, dateTime: event },
                })
              }
              showTimeSelect
              timeFormat="HH:mm"
