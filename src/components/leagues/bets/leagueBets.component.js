...
export default class LeagueBetsComponent extends Component {
    ...
    this.panes = [
      {
        ...
        render: () => (
          <Tab.Pane>
            <SpecialBetsSerieComponent match={this.props.match} />
          </Tab.Pane>
        ),
      },
      {
        ...
        render: () => (
          <Tab.Pane>
            <SpecialBetsSingleComponent match={this.props.match} />
          </Tab.Pane>
        ),
      },
    ];
  ...
  render() {
    return <Tab panes={this.panes} onTabChange={this.onTabChanged} activeIndex={this.state.activeIndex} />;
  }
}
