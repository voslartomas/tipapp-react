    ...
    return (
      <div>
        ...
        <Link to={`/leagues/${this.props.match.params.leagueId}/bets/single/form/new`}>
          <Button primary>Přidat sázku na sérii</Button>
        </Link>
        <Divider />
        <Table celled>
          <Table.Header>
              ...
              this.state.bets.map((bet) => (
                <Table.Row>
                  ...
                  <Table.Cell>
                    ...
                    {bet.specialBetPlayerResult &&
                      `${bet.specialBetPlayerResult.player.firstName} ${bet.specialBetPlayerResult.player.lastName}`}
                    {bet.specialBetValue && bet.specialBetValue}
                  </Table.Cell>
                  <Table.Cell>{bet.points}</Table.Cell>
                  <Table.Cell>
                    <Link
                      to={`/leagues/${this.props.match.params.leagueId}/bets/single/form/${bet.id}`}
                    ...
                    <Modal size="small" open={this.state.open} onClose={this.handleDeleteCancel}>
                      <Modal.Header>Smazat {bet.id} ?</Modal.Header>
                      <Modal.Content>
                      ...
                      <Modal.Actions>
                        ...
                        <Button
                          positive
                          onClick={() => this.handleDeleteConfirm(bet.id)}
                          icon="checkmark"
                          labelPosition="right"
                          content="Ano"
                        />
