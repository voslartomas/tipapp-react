          ...
          <Form.Field>
            <Form.Select
              ...
              onChange={(event, { name, value }) => {
                this.setState({ leagueUser: { ...this.state.leagueUser, userId: value } })
              }}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              onChange={() => this.setState({ leagueUser: { ...this.state.leagueUser, paid: !this.state.leagueUser.paid } })}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
              ...
              onChange={() => this.setState({ leagueUser: { ...this.state.leagueUser, active: !this.state.leagueUser.active } })}
            />
          </Form.Field>
          <Form.Field>
            <Checkbox
