    ...
    return (
      <div>
        ...
        <Link to="/sports/form/new">
          <Button primary>Přidat sport</Button>
        </Link>
        <Link to="/teams/form/new">
          <Button primary>Přidat tým</Button>
        </Link>
            ...
            this.state.sports.map((sport) => (
              <Card key={sport.id}>
                <Card.Content>
                  ...
                  <Link to={`/sports/form/${sport.id}`} style={{ marginRight: '5px' }}>
                    Upravit
                  </Link>
              ...
              /> */}
                  <Modal size="small" open={this.state.open} onClose={this.handleDeleteCancel}>
                    <Modal.Header>Smazat {sport.czName} ?</Modal.Header>
                    <Modal.Content>
                    ...
                    <Modal.Actions>
                      ...
                      <Button
                        positive
                        onClick={() => this.handleDeleteConfirm(sport.id)}
                        icon="checkmark"
                        labelPosition="right"
                        content="Ano"
                      />
