...
export default class MatchFormComponent extends Component {
  ...
  async componentDidMount() {
    ...
    if (matchId !== 'new') {
      try {
        ...
        players = await PlayerService.getPlayersByTeams(this.props.match.params.leagueId, [
          match.homeTeamId,
          match.awayTeamId,
        ]);
      } catch (e) {
  ...
  getPlayers(match) {
    ...
    return this.state.players
      .filter((player) => player.leagueTeamId === match.homeTeamId || player.leagueTeamId === match.awayTeamId)
      .map((player) => ({
        key: player.id,
        ...
        <Form onSubmit={() => this.saveForm()}>
          <Form.Field style={{ display: 'none' }}>
            <Form.Select
              ...
              onChange={(event, { name, value }) => {
                this.setState({
                  match: { ...this.state.match, leagueId: value },
                });
              }}
            />
          </Form.Field>
          <Form.Field>
            <Form.Select
              ...
              onChange={(event, { name, value }) => {
                this.setState({
                  match: { ...this.state.match, homeTeamId: value },
                });
              }}
            />
          </Form.Field>
          <Form.Field>
            <Form.Select
              ...
              onChange={(event, { name, value }) => {
                this.setState({
                  match: { ...this.state.match, awayTeamId: value },
                });
              }}
            />
          </Form.Field>
          <Form.Field>
            ...
            <Input
              ...
              onChange={(event) =>
                this.setState({
                  match: { ...this.state.match, homeScore: event.target.value },
                })
              }
            />
          </Form.Field>
          <Form.Field>
            ...
            <Input
              ...
              onChange={(event) =>
                this.setState({
                  match: { ...this.state.match, awayScore: event.target.value },
                })
              }
            />
          </Form.Field>
          <Form.Field>
            ...
            <Form.Select
              ...
              onChange={(e, { name, value }) =>
                this.setState({
                  match: { ...this.state.match, scorers: value },
                })
              }
          ...
          <Form.Field>
            ...
            <DatePicker
              ...
              onChange={(event) =>
                this.setState({
                  match: { ...this.state.match, dateTime: event },
                })
              }
              showTimeSelect
              timeFormat="HH:mm"
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  match: {
                    ...this.state.match,
                    overtime: !this.state.match.overtime,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  match: {
                    ...this.state.match,
                    shotout: !this.state.match.shotout,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  match: {
                    ...this.state.match,
                    isPlayoffGame: !this.state.match.isPlayoffGame,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  match: {
                    ...this.state.match,
                    isEvaluated: !this.state.match.isEvaluated,
                  },
                })
              }
            />
            ...
            <Checkbox
              ...
              onChange={() =>
                this.setState({
                  match: {
                    ...this.state.match,
                    isDoubled: !this.state.match.isDoubled,
                  },
                })
              }
            />
