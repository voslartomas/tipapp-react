...
export default class LeagueUserService {
  ...
  static async delete(leagueId, userId) {
    return await api.delete(`api/leagues/${leagueId}/users/${userId}`)
  }

  static async create(leagueId, data) {
    return await api.put(`api/leagues/${leagueId}/users/0`, data)
  }

  static async update(leagueId, data, id) {
    return await api.put(`api/leagues/${leagueId}/users/${id}`, data)
  }
}
